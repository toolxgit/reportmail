...
function getDailyRevenue(year, month, day) {
    ...
    try {
      ...
      request(options)
        .then((orders) => {
          ...
          res.status(200).json({
            "success": true,
            "CurrentDayrOrderCount": currentOrderCount,
            "CurrentDayOrderRevenue": currentOrderRevenue,
            "LastDayOrderCount": lastYearOrderCount,
            "LastDayOrderRevenue": lastYearOrderRevenue
          });
        })
        .catch((error) => {
    ...
    try {
      ...
      request(options)
        .then((orders) => {
          ...
          res.status(200).json({
            "success": true,
            "CurrentMonthOrderCount": currentOrderCount,
            "CurrentMonthOrderRevenue": currentOrderRevenue,
            "LastMonthOrderCount": lastYearOrderCount,
            "LastMOnthOrderRevenue": lastYearOrderRevenue
          });
        })
        .catch((error) => {
          res.status(404).json({ success: false, message: "No orders found" });
...
router.get('/get-data', (req,res) => {
  ...
  getDailyRevenue(year, month, day);
